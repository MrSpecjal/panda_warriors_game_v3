...
public class UIToolbar : EditorWindow, IHasCustomMenu
{
	private class Data
	{
	...
	private UIToolbarSettings m_settings;
	private UIToolbarSettings Settings
	{
		get { return m_settings ?? ( m_settings = AssetDatabase.LoadAssetAtPath<UIToolbarSettings>( m_dir + "/UIToolbarSettings.asset" ) ); }
	}
	...
	[MenuItem( "Wind Engine/Toolbars/UI Toolbar" )]
	private static void Init()
	{
		var win = GetWindow<UIToolbar>( TITLE );
